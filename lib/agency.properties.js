...
const doEverything = (isSecondary = false, aId, realtimeUrl, dbUser, dbPass, dbHost) => storeProperties(...generateProperties(generateStruct(aId, realtimeUrl, dbUser, dbPass, dbHost), isSecondary))
